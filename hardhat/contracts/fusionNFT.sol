...
contract fusionNFT is NFTTemplate {
    ...
    constructor()
        NFTTemplate("FusionNFT4", "FUN4", "ipfs://bafkreid4jqgen3erpgaua7u7iywzzdatolmopwpkldtnjiali2wy5qwanq")
    {
    }
    ...
    function mint2(address _to,  string calldata _uri) public onlyAdmin {
        _mint(_to, tokenIdCnt);
        _tokenURIs[tokenIdCnt] = _uri;
		tokenIdCnt += 1;
    }
